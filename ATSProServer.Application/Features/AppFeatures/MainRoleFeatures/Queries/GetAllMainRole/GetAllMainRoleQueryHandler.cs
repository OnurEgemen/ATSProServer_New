...
public sealed class GetAllMainRoleQueryHandler : IQueryHandler<GetAllMainRoleQuery,
    GetAllMainRoleQueryResponse>
{
    ...
    public async Task<GetAllMainRoleQueryResponse> Handle(GetAllMainRoleQuery request, 
